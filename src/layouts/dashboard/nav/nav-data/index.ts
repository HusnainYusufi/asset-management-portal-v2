...
export const useFilteredNavData = () => {
	...
	const authCodes = useMemo(() => Array.from(new Set([...permissionCodes, ...roleCodes])), [permissionCodes, roleCodes]);
	const filteredNavData = useMemo(() => filterNavData(authCodes), [authCodes]);
