...
It gives you a production-ready **dashboard UI** with optional authentication, charts, tables, forms, and a feature-based folder structure, perfect for **SaaS apps, internal tools, and admin panels**.
...
- 🔐 **Authentication-ready** layout with placeholder auth screens

- 🏢 **Multi-tenant workspaces** UI with configurable data sources

- 💳 **Billing & subscriptions** section ready for your billing provider
...
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Signup / Signin](https://shadcn-dashboard.kiranism.dev/auth/sign-in)                                                                                                  | Placeholder authentication screens ready for your auth provider integration.                                                                                                                                                                                           |
...
| [Profile](https://shadcn-dashboard.kiranism.dev/dashboard/profile)                                                                                                     | Profile placeholder with mock user data, ready for provider integration.                                                                                                                                                                                                |
| [Kanban Board](https://shadcn-dashboard.kiranism.dev/dashboard/kanban)                                                                                                 | A Drag n Drop task management board with dnd-kit and zustand to persist state locally.                                                                                                                                                                                  |
| [Workspaces](https://shadcn-dashboard.kiranism.dev/dashboard/workspaces)                                                                                               | Workspace management UI with mock data, ready for your multi-tenant backend.                                                                                                                                                                                            |
| [Team Management](https://shadcn-dashboard.kiranism.dev/dashboard/workspaces/team)                                                                                     | Team management placeholder UI showing example roles and members.                                                                                                                                                                                                       |
| [Billing & Plans](https://shadcn-dashboard.kiranism.dev/dashboard/billing)                                                                                             | Billing placeholder with instructions to connect your payment provider.                                                                                                                                                                                                 |
| [Exclusive Page](https://shadcn-dashboard.kiranism.dev/dashboard/exclusive)                                                                                            | Example of plan-based access control using mock plan data with fallback UI.                                                                                                                                                                                             |
...
To configure the environment for this project, refer to the `env.example.txt` file. This file contains the necessary environment variables required for error tracking.
